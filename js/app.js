...
function renderAchievements() {
  ...
  target.innerHTML = `
    ...
    <div
      class="achievement-card rounded-2xl p-5"
    >
        ...
        >
          ...
          ${
            leader
              ? `${escapeHtml(
                  leader.name
                )} is currently leading the scoring charts.`
...
function initFloatingSocial() {
  ...
  function update() {
    ...
    if (
      ...
      const rect =
        socialSection.getBoundingClientRect();
  ...
  ids.forEach(
    id => {
      ...
      if (element) {
        ...
        element.innerHTML = `
          <p
            class="text-red-400 text-sm p-4"
          >
